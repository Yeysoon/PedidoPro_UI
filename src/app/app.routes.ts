...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      { path: 'dashboard', loadComponent: () => import('./pages/dashboard/dashboard.component').then(m => m.DashboardComponent), canActivate: [roleGuard], data: { roles: ['Administrador'] } },
      ...
      { path: 'pedidos',   loadComponent: () => import('./pages/pedidos/pedidos.component').then(m => m.PedidosComponent),      canActivate: [roleGuard], data: { roles: ['Mesero'] } },
      { path: 'cocina',    loadComponent: () => import('./pages/cocina/cocina.component').then(m => m.CocinaComponent),         canActivate: [roleGuard], data: { roles: ['Cocinero'] } },
      { path: 'caja',      loadComponent: () => import('./pages/caja/caja.component').then(m => m.CajaComponent),               canActivate: [roleGuard], data: { roles: ['Cajero'] } },
